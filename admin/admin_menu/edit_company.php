        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
              ...
              <div class="edit">
                ...
                <?php
                if(isset($_POST["edit"])) {
                  $company->edit_company_profile($_POST['bedrijfnaam'], $_POST['adres'], $_POST['postcode'], $_POST['woonplaats'], $_POST['email'], $_POST['gebruikersnaam'], $_GET['bedrijfID']);
                  echo '<script>location.href="edit_company.php?bedrijfID='.$_GET['bedrijfID'].'"</script>';
                 }
